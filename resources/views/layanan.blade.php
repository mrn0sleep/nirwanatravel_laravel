...
.hero-lyn h1 { font-family: 'Playfair Display', serif; color: #fff; font-size: clamp(1.9rem, 4.5vw, 2.9rem); line-height: 1.15; margin-bottom: 16px; }
...
/* ── SECTION HEADER ──────────────────────────────── */
.sec-label { display: inline-block; background: #eef2ff; color: #1e4dbf; font-size: .69rem; font-weight: 700; letter-spacing: .11em; text-transform: uppercase; padding: 5px 14px; border-radius: 50px; margin-bottom: 12px; }
.sec-title { font-family: 'Playfair Display', serif; font-size: clamp(1.5rem, 3vw, 2.1rem); color: #0c1d3a; margin-bottom: 10px; }
...
.kartu-paket:hover { transform: translateY(-6px); box-shadow: 0 18px 44px rgba(13,31,60,.13); border-color: #c9d4ec; }
.kartu-paket .thumb { position: relative; overflow: hidden; }
.kartu-paket .thumb img { width: 100%; height: 190px; object-fit: cover; display: block; transition: transform .42s ease; }
.kartu-paket:hover .thumb img { transform: scale(1.06); }
.no-img { width: 100%; height: 190px; background: linear-gradient(135deg, #e8ecf4, #d0d9ee); display: flex; align-items: center; justify-content: center; color: #9baac8; font-size: 2.2rem; }
.badge-lokasi {
...
.badge-jenis { position: absolute; top: 10px; right: 10px; padding: 4px 10px; border-radius: 6px; font-size: .68rem; font-weight: 700; }
...
.kartu-paket .isi { padding: 18px 18px 10px; flex: 1; display: flex; flex-direction: column; }
.kartu-paket .judul-paket { font-size: .95rem; font-weight: 700; color: #0c1d3a; margin-bottom: 8px; line-height: 1.4; min-height: 46px; }
.kartu-paket .deskripsi-singkat { font-size: .8rem; color: #6b7a90; line-height: 1.65; margin-bottom: 12px; }
.info-row { display: flex; align-items: center; gap: 6px; font-size: .78rem; color: #8a9bc0; margin-bottom: 6px; }
...
.btn-pesan {
  flex: 1; display: inline-flex; align-items: center; justify-content: center; gap: 6px;
  padding: 9px 12px; border-radius: 10px;
  background: #1fa563; color: #fff; font-size: .82rem; font-weight: 600; transition: all .2s;
}
.btn-pesan:hover { background: #18935a; color: #fff; }

/* ── STATE KOSONG ────────────────────────────────── */
.state-kosong { text-align: center; padding: 70px 20px; color: #8a9bc0; }
.state-kosong .icon-wrap { width: 80px; height: 80px; border-radius: 50%; background: #f0f2f8; display: flex; align-items: center; justify-content: center; font-size: 2rem; color: #c3cde3; margin: 0 auto 18px; }
